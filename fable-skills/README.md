# Fable Skills — WellInsight 寓言 v1 渲染完整复现包

> **项目代号**: Fable-Skills (WellInsight 寓言系列第 02-12 章沉淀的可复用 skills 包)
...
就能从 0 渲染出符合 v5 规范的寓言章节 HTML,**不依赖原团队环境 / mem0 L2 库 / WellInsight 项目历史**。
...
- **内部沉淀**:WellInsight 项目内部使用,允许修改和分发
- **复用条件**:遵守 `01-sop/` 3 份 SOP 规范,标注 WellInsight 项目出处
...
**包版本**: v1.0 (2026-06-29 沉淀, ch12 0 修复验证)
**维护**: 寓言系列作者
